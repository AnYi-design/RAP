# **目录**
- [**目录**](#目录)
  - [@UI.fieldGroup 属性详解](#uifieldgroup-属性详解)
  - [基本语法](#基本语法)
  - [属性详解](#属性详解)
      - [@UI.fieldGroup.qualifier](#uifieldgroupqualifier)
      - [@UI.fieldGroup.position](#uifieldgroupposition)
      - [@UI.fieldGroup.groupLabel](#uifieldgroupgrouplabel)
      - [@UI.fieldGroup.hidden](#uifieldgrouphidden)
      - [@UI.fieldGroup.exclude](#uifieldgroupexclude)
      - [@UI.fieldGroup.inline](#uifieldgroupinline)
      - [@UI.fieldGroup.emphasized](#uifieldgroupemphasized)
      - [@UI.fieldGroup.cssDefault.width](#uifieldgroupcssdefaultwidth)
      - [@UI.fieldGroup.importance](#uifieldgroupimportance)
      - [@UI.fieldGroup.criticality](#uifieldgroupcriticality)
      - [@UI.fieldGroup.criticalityRepresentation](#uifieldgroupcriticalityrepresentation)
      - [@UI.fieldGroup.type](#uifieldgrouptype)
          - [FOR\_ACTION](#for_action)
          - [WITH\_ACTION](#with_action)
          - [AS\_CONNECTED\_FIELDS](#as_connected_fields)
      - [@UI.fieldGroup.dataAction](#uifieldgroupdataaction)
      - [@UI.fieldGroup.determining](#uifieldgroupdetermining)
      - [@UI.fieldGroup.actionGroupId](#uifieldgroupactiongroupid)
      - [@UI.fieldGroup.isCopyAction](#uifieldgroupiscopyaction)
      - [@UI.fieldGroup.navigationAvailable](#uifieldgroupnavigationavailable)
      - [@UI.fieldGroup.requiresContext](#uifieldgrouprequirescontext)
      - [@UI.fieldGroup.invocationGrouping](#uifieldgroupinvocationgrouping)
      - [@UI.fieldGroup.semanticObject](#uifieldgroupsemanticobject)
      - [@UI.fieldGroup.semanticObjectAction](#uifieldgroupsemanticobjectaction)
      - [@UI.fieldGroup.semanticObjectBinding.element](#uifieldgroupsemanticobjectbindingelement)
      - [@UI.fieldGroup.semanticObjectBinding.localElement](#uifieldgroupsemanticobjectbindinglocalelement)
      - [@UI.fieldGroup.semanticObjectBinding.localParameter](#uifieldgroupsemanticobjectbindinglocalparameter)
      - [@UI.fieldGroup.value](#uifieldgroupvalue)
      - [@UI.fieldGroup.valueQualifier](#uifieldgroupvaluequalifier)
      - [@UI.fieldGroup.url](#uifieldgroupurl)
      - [@UI.fieldGroup.iconUrl](#uifieldgroupiconurl)
      - [@UI.fieldGroup.targetElement](#uifieldgrouptargetelement)
      - [@UI.fieldGroup.rowSpanForDuplicateValues](#uifieldgrouprowspanforduplicatevalues)
      - [@UI.fieldGroup.isPartOfPreview](#uifieldgroupispartofpreview)
...
> #FOR_ACTION - 操作字段
>
> #WITH_ACTION - 可操作字段 效果是以link形式显现
>
...
###### WITH_ACTION
> 具体点击link之后的弹窗请看[Behavior中的action部分](Behavior/Behavior.md)
> 
metadata
```
@UI:{
